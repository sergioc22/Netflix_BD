<?php 
  ...
  $registros = mysqli_query($conexion, "SELECT * FROM persona_contenido P JOIN dirige D ON P.Id_Persona_Cont = D.Id_Persona_Cont WHERE D.Id_Contenido = '$_GET[idcontenido]'");
