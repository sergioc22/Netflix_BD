<?php 
  ...
  $registros = mysqli_query($conexion, "SELECT * FROM persona_contenido P JOIN actua A ON P.Id_Persona_Cont = A.Id_Persona_Cont WHERE A.Id_Contenido = '$_GET[idcontenido]'");
