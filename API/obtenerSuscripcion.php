<?php 
  ...
  $registros = mysqli_query($conexion, "SELECT DISTINCT Nombre FROM suscripcion S JOIN requiere R ON S.Id_Suscripcion = R.Id_Suscripcion WHERE R.Id_Contenido = $_GET[idcontenido]");
